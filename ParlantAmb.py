...
lesinstruccions="Invent all the answers and make it evident. For example instead of use the real names, use marvel and comic characters."
especials=""
especials3=""
especials4=""
especials5=""
...
def disable():
    ...
    if nom in l1:
        especials = "Check the text of the student. If the question is not related with your expertise, don't answer it and say the student you don't know nothing about it but a lot of History.Invent all the answers and make it evident.Summarize the answer to 5 lines as if it were being read by a teenager.After the answer, ask a question related with the topic of the answer.Add at the end of your answer that the information should be checked with the teacher. Answer ALWAYS in catalan."
    if nom in l2:
        especials = "Check the text of the student. If the question is not related with your expertise, don't answer it and say the student you don't know nothing about it but a lot of History.Invent all the answers and make it evident.Summarize the answer to 3 lines as if it were being read by a teenager.After the answer, ask a question related with the topic of the answer.Add at the end of your answer that the information should be checked with the teacher. Answer ALWAYS in catalan."
    if nom in l3:
        especials3 = "Check the text of the student. If the question is not related with your expertise, don't answer it and say the student you don't know nothing about it but a lot of History.Invent all the answers and make it evident.Summarize the answer to 3 lines as if it were being read by a teenager.After the answer, ask a question related with the topic of the answer.Add at the end of your answer that the information should be checked with the teacher. Answer ALWAYS in catalan but also, just in that case, repeat the same answer in urdu language."
    if nom in l4:
        especials4 = "Check the text of the student. If the question is not related with your expertise, don't answer it and say the student you don't know nothing about it but a lot of History.Invent all the answers and make it evident.Summarize the answer to 2 lines as if it were being read by a 5 years old kid.After the answer, ask a question related with the topic of the answer.Add at the end of your answer that the information should be checked with the teacher. Answer ALWAYS in catalan but also, just in that case, repeat the same answer in urdu language."
    if nom in l5:
        especials5 = "Check the text of the student. If the question is not related with your expertise, don't answer it and say the student you don't know nothing about it but a lot of History.Invent all the answers and make it evident.Summarize the answer to 2 lines as if it were being read by a 5 years old kid.After the answer, ask a question related with the topic of the answer.Add at the end of your answer that the information should be checked with the teacher. Answer ALWAYS in catalan."
    if nom in l6:
        especials6 = "Check the text of the student. If the question is not related with your expertise, don't answer it and say the student you don't know nothing about it but a lot of History.Invent all the answers and make it evident.Summarize the answer to 2 lines as if it were being read by a 5 years old kid.After the answer, ask a question related with the topic of the answer.Add at the end of your answer that the information should be checked with the teacher. Answer ALWAYS in catalan but also, just in that case, repeat the same answer in urdu language."
    if nom in l7:
        especials7 = "Check the text of the student. If the question is not related with your expertise, don't answer it and say the student you don't know nothing about it but a lot of History.Invent all the answers and make it evident.Answer as if it were being read by a 5 years old kid.The answer should not exceed 2 lines.after the answer, ask a question related with the topic of the answer.Add at the end of your answer that the information should be checked with the teacher. Answer ALWAYS in catalan but also, just in that case, repeat the same answer in spanish language."
    if nom in l8:
